...
<head>
  ...
  <script src="BasicJavaScript.js"></script>
  <script type="text/javascript">
  	window.onload = function() {
  		//alert("Initial Load");
  		sessionStorage.setItem("Example-quiz", "false");
  		var a=document.getElementById("exampleLink");
  		a.onclick = function() {
  			sessionStorage.setItem("Example-quiz", "true");
  		}
  	}
  </script>
...
<body>
		...
		<section class='container'>
				  ...
				  <h2>Study System</h2>
				  <p>This web site is something intended to be useful for students. It allows you to enter categories, 
				  	then within those categories enter questions and correct answers.  Then you can quiz yourself on a 
				  	specific category or on all of your quiz questions.</p>
				  <p>
				  	The site was built to fill a need that didn't seem to be addressed elsewhere on the Internet.  Yes,
				  	there are plenty of web sites that allow anyone to create their own quizzes.  A lot of those sites,
				  	though, only allow you to create quizzes with a limited number of questions for free, after which you 
				  	have to pay.
				  </p>
				  <p>
				  	Also, a lot of those sites seem geared towards instructors who want to create quizzes to evaluate
				  	students, presumably after they've studied material. 
				  </p>
				  <p>
				  	Students are often people who have a lot of information to learn and memorize - and not a lot of
				  	extra money to spend.  So, this site does not limit the number of questions you can enter, and it
				  	is offered here online for free with that in mind.
				  </p>
				  <p>
				  	It is not an attempt to directly compete with existing sites that mark you.  On this site, after
				  	you enter an answer to a question, you can click a button to see the correct answer and see
				  	for yourself if you are correct.
				  </p>
				  <p>
				  	The text boxes for answers are fairly large and will scroll, for two reasons.  For a subject like 
				  	computer programming, questions and answers involving snippets of code often require
				  	several lines.  Also, this can facilitate the learning process because when you get an answer
				  	wrong, you can immediately type the correct answer several times in the answer box if that will
				  	help you memorize a fact.
				  </p>
				  <p>
				  	For the moment, this site will store the data you enter in your own browser's local storage.  
				  	Please be aware that this means it could be lost depending on whether you clear your browser's 
				  	memory.  Permanently saving information in an online database is something that is currently
				  	being looked into and worked on. In the meantime, if you have a main browser you use, you may 
				  	wish to install a second one for use with a site like this. FireFox portable is designed to 
				  	be installed and run on memory cards, and can be helpful in situations like this.  
				  </p>
                  <ul>
                    
                    <li><a id = "exampleLink" href="TakeAQuiz.html">Example Quiz - </a>Look here to see what the site can do</li>   
                    <li><a href="AddCategories.html">Add Categories - </a>Start here if you want to start setting up your own quizzes</li>   
                    <li><a href="AddQuestions.html">Add Questions - </a>Go here after you've created at least one category</li>   
                    <li><a href="TakeAQuiz.html">Take A Quiz - </a>You can go here after you've added some questions</li>                         
                    <li><a href="UpdateQuestions.html">Update Questions - </a>Use this to correct quiz questions you've entered</li>                              
